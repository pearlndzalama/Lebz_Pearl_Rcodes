#==================================================================================
# Low Spatial Autocorrelation Data Generation
#==================================================================================
...
Y <- (beta_0 + beta_1*values(Xvar3) + beta_2*values(Xvar3)^2 + 
        0.5*values(Xraster1) + 0.5*values((Xraster2))+ eps) # we need an error term attached to our y_variable
